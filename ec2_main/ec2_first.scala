...
def findByTypeAndCategoryAND(line:String,tpe:String,category:String):Boolean = {
  ...
  def main(args: Array[String]) {
    ...
    val inputUS = sc.textFile("hdfs://ec2-23-23-46-21.compute-1.amazonaws.com:9000/cloud/data/reverbed.txt")
    val input = sc.textFile("hdfs://ec2-23-23-46-21.compute-1.amazonaws.com:9000/cloud/data/final.txt")
